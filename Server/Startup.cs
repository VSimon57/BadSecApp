    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            using (var conn = new SqliteConnection("Data Source=test.db"))
            {
                ...
                commande = conn.CreateCommand();
                commande.CommandText = "INSERT INTO USERS (login, hash) VALUES ('user', 'f71dbe52628a3f83a77ab494817525c6')"; // SECU création utilisateur facile d'accés toto. 
                commande.ExecuteNonQuery();
            }

            string ChaineConnexion = Configuration.GetConnectionString("DefaultConnection"); // SECU ? A expliquer
            if (ChaineConnexion.Contains("password")) throw new ApplicationException(); // SECU ? A expliquer
